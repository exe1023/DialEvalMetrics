...
def BatchedDot(x, y, last_axis=False):
    if last_axis == False:
        ...
        if x.ndim == 2:
            ...
            raise ValueError(
                'BatchedDot inputs must have between 2-4 dimensions, but x has ' + str(x.ndim) + ' dimensions')
        ...
        if y.ndim == 2:
            ...
            raise ValueError(
                'BatchedDot inputs must have between 2-4 dimensions, but y has ' + str(y.ndim) + ' dimensions')
