...
max_sentences_per_language = 2000000 #Maximum number of  parallel sentences for training
...
dev_sentences = 2014                 #Number of parallel sentences to be used for development
...
for source_lang in source_languages:
    for target_lang in target_languages:
        output_filename_train = os.path.join(parallel_sentences_folder, "train-{}-{}.tsv.gz".format(source_lang, target_lang))
        output_filename_dev = os.path.join(parallel_sentences_folder, "dev-{}-{}.tsv.gz".format(source_lang, target_lang))
